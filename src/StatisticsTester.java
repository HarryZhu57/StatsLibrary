...
//		System.out.println("Using hyper geometric distribution, with 5 red balls and 7 blue balls, probability of 4 being red balls out of 10 chosen : " + stats.getHyperGeo(n,r,o,l) + "%");
//		System.out.println("Using poisson distribution, probability of exactly 10 customers coming in with the average customers being 12 : " + stats.getPoisson(o, n) + "%");
		System.out.println("Using chebychevs theorem, percentage of people falling within a certain weight range knowing the average is 8, the standard deviation is 2, and the upper bound is 12: " + stats.getCheb(50, 7, 60, 40) + "%");
		
//		System.out.println("Using uniform distribution, the probability of getting 4 or under when looking at a range of 2 to 12: " + stats.getUniform(d, o, r));
	}
}
