...
int[] Arr = {1, 2, 20, 4, 6, 20};
		...
		System.out.println("Using chebychevs theorem, percentage of people falling within a certain weight range knowing the average is 8, the standard deviation is 2, and the upper bound is 12: " + stats.getCheb(a, d, o, r) + "%");
